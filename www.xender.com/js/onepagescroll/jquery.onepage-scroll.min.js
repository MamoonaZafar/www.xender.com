! function(e) {
    ...
    e.fn.onepage_scroll = function(n) {
        ...
        e.fn.transformPage = function(t, n) {
            e(this).css({
            ...
            if (index < total) {
                ...
                if (next) {
                    ...
                    if (r.pagination == true) {
                        ...
                        e(".onepage-pagination li a" + "[data-index='" + (index + 1) + "']").addClass("active")
                    }
        ...
        i.swipeEvents().bind("swipeDown", function() {
            i.moveUp()
